...
\hline
RFS003 & Baixar Modelos 3D & Oferecer a opção de \textit{download} de modelos 3D do sítio arqueológico. & Essencial \\
\hline
RFS004 & Baixar Ambiente Virtual & Disponibilizar o arquivo executável do ambiente virtual desenvolvido na Unreal Engine para \textit{download} pelos usuários. & Essencial \\
\hline
...
\hline
\endhead % Cabeçalho das páginas seguintes
RNFS001 & Tempo de Carregamento & O sistema deve carregar as páginas em até 6 segundos em uma conexão de 5 Mbps. & Essencial \\
\hline
